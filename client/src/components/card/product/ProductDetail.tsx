...
const ProductDetail = ({ product }: ProductDetailProps) => {
  return (
    <>
      <p className="text-3xl font-semibold z-20 relative">{product._title}</p>
      <div className="p-2 m-2 about-product ">
        <p className="font-bold text-xl">About Product</p>
        <ul className="text-lg list-disc ml-10">
          <li>{product._feature_1}</li>
          <li>{product._feature_2}</li>
          <li>{product._feature_3}</li>
          <li>{product._feature_4}</li>
        </ul>
      </div>
